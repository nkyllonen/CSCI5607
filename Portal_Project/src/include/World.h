...
public:
	...
	void drawNonPortals(Camera * cam, GLuint shaderProgram, GLuint uniTexID, glm::mat4 const& view, glm::mat4 const& proj);
	void drawSinglePortal(WO_Portal* portal, Camera * cam, GLuint shaderProgram, GLuint uniTexID,
